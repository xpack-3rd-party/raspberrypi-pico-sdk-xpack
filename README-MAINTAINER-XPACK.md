...
and fix them; assign them to a milestone (like `2.3.0-3`).
...
- add a new entry like _* v2.3.0-3_
- commit with a message like _prepare v2.3.0-3_
...
- `npm dist-tag add @xpack-3rd-party/raspberrypi-pico-sdk@2.3.0-3 latest`
- `npm dist-tag ls @xpack-3rd-party/raspberrypi-pico-sdk`
